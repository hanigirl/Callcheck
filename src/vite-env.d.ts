...
declare module '@design-system' {
  ...
  export { Table, TableColumn, TableRow } from '../design-system/components/Table';
  export { Quote } from '../design-system/components/Quote';
  export { Tag } from '../design-system/components/Tag';
  export { CallCard } from '../design-system/components/CallCard';
  export { FaultCard } from '../design-system/components/FaultCard';
